...
function Header() {
  ...
  return (
  <div>
      <div className="w-[425px]  lg:pt-8 lg:w-[1024px] ">
      <nav className="bg-white rounded md:gap-[110px]">
        <div className=" w-screen px-4 py-4 flex flex-wrap items-center justify-between mx-auto bg-white md:flex md:flex-row md:w-[768px] md:p-2  lg:w-[1024px]">
        ...
        <hr className="h-[1px] hidden md:block w-[768px] lg:block lg:w-[1024px]"/>
  </div>
  );
}
