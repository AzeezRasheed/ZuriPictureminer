...
function Apply() {
  return (
    <div className="flex flex-col items-center w-[425px] bg-white md:w-[768px]  lg:w-[1024px] md:mt-10">
      <div className="p-4">
        ...
        <img src={Group1} alt="Apply" />
          <div className="flex flex-col items-center gap-3 md:text-start md:items-start md:gap-[10px] md:w-[369px] md:h-[214px] lg:w-[522px] lg:h-[250px] ">
            ...
            <p className=" w-[365px] h-[90px] font-sans font-normal text-[12px] leading-[18px] text-center text-[1D1D1D] md:w-[365px] md:text-[14px] md:text-start lg:text-[16px] lg:leading-[24px]  ">
              Want to become a part of the Minergram partnership ecosystem? Our
              Head of Partnerships will get in touch with you after you complete
              the form below to start the conversation and learn more about your
              company and how your solution supports merchant growth.
            </p>
          </div>
        </div>
          <FormInputApply/>
