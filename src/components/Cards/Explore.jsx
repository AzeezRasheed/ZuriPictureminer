    ...
    <div className="bg-white flex flex-col text-center items-center w-[425px] md:w-[768px]  lg:w-[1024px] ">
      <div className="flex flex-col pt-[80px] pb-36   items-center gap-[50px]    ">
        <div className="text-center gap-[10px] flex flex-col w-[307px] h-[114px] md:w-[666px] md:h-[72px]  ">
          <h1 className="pl-[25px] w-[287px] h-[68px] font-sans font-bold text-[24px] leading-[34px] text-[#1D1D1D] text-center md:w-[666px] md:h-[42px] md:pl-[14px] md:text-[30px] lg:text-[40px] lg:pr-4 ">
            {" "}
            Explore Our Partnership Programs{" "}
          </h1>
          <p className=" w-[307px] h-[36px] font-sans font-normal text-[12px] leading-[18px] text-center text-[1D1D1D] md:w-[666px] md:h-[20px] md:text-[14px] lg:text-[16px] lg:leading-[24px] ">
